        ...
        <div class="col-md-8">
            <div class="product-details mr-2">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                    <div class="d-flex flex-row"><img class="rounded" src="{{asset('image/product1.webp')}}" width="40">
                        <div class="ml-2"><span class="font-weight-bold d-block">Timeless style</span><span class="spec">256GB, Navy Blue</span></div>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                    <div class="d-flex flex-row"><img class="rounded" src="{{asset('image/product2.webp')}}" width="40">
                        <div class="ml-2"><span class="font-weight-bold d-block">Oyster Perpetual</span><span class="spec">256GB, Navy Blue</span></div>
                    </div>
                    <div class="d-flex flex-row align-items-center"><span class="d-block">2</span><span class="d-block ml-5 font-weight-bold">$900</span><i class="fa fa-trash-o ml-3 text-black-50"></i></div>
                </div>
                <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                    <div class="d-flex flex-row"><img class="rounded" src="{{asset('image/product3.webp')}}" width="40">
                        <div class="ml-2"><span class="font-weight-bold d-block">Cosmograph Daytona</span><span class="spec">256GB, Axe black</span></div>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                    <div class="d-flex flex-row"><img class="rounded" src="{{asset('image/product4.webp')}}" width="40">
                        <div class="ml-2"><span class="font-weight-bold d-block">LADY-DATEJUST</span><span class="spec">256GB, Navy Blue</span></div>
                    </div>
